...
{
    if(origin.find("½ñÌì") != std::string::npos ||
       origin.find("½ñÈÕ") != std::string::npos)
        return Today;
    
    if(origin.find("Ã÷Ìì") != std::string::npos ||
       origin.find("Ã÷ÈÕ") != std::string::npos)
        return Tomorrow;
    
    if(origin.find("±¾ÖÜ") != std::string::npos)
        return ThisWeek;
    
    if(origin.find("±¾ÔÂ") != std::string::npos)
        return ThisMonth;

    if(origin.find("½ñÄê") != std::string::npos)
        return ThisYear;
