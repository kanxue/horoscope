...
#define SUBSCRIBE_WORDING "你已经成功添加女巫店十二星座运势为好友啦. 首先输入“绑定 你的生日”来关联自己的星座，比如“绑定 1月12日”，然后就可以获取你的专属星座运势啦。玩转自定义回复获取关心的星座运势：比如“双子 本周”可以查询本周运势；直接输入日期如“1月12日”或者“0112“可以查询该日期所属星座的今日运势。喜欢就记得推荐给朋友吧，不相信星座的同志不是好同志mo-亲亲"
